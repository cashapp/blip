...
|[`wait.io.table`](domains#iotable)|Table IO Wait metrics [`performance_schema.table_io_waits_summary_by_table`](https://dev.mysql.com/doc/refman/5.7/en/performance-schema-table-wait-summary-tables.html#performance-schema-table-io-waits-summary-by-table-table)|v1.0.??|
