...
func buffered_stack(rb *BufferedRetry) []string {
	stack := []string{}
	rb.stackMux.Lock()
...
func TestBufferedRetry(t *testing.T) {
	...
	rb.Send(context.Background(), metrics1)
...
func TestBufferedRetryPopMiddle(t *testing.T) {
...
func TestBufferedRetry_NoDeltaSink(t *testing.T) {
	mockSink := mock.Sink{
		SendFunc: func(ctx context.Context, m *blip.Metrics) error {
			return nil
		},
